                    ...
                    <div className="space-y-4 sm:space-y-6 order-2 md:order-1">
                        <div className="bg-card rounded-lg p-4 sm:p-6 border border-border shadow-sm hover:shadow-md transition-shadow flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground text-sm sm:text-base">aouns6229@gmail.com</p>
                                <p className="text-muted-foreground text-sm sm:text-base">support@aoun.com</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-card rounded-lg p-4 sm:p-6 border border-border shadow-sm hover:shadow-md transition-shadow flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground text-sm sm:text-base">(+92)3086724165</p>
                        ...
                        <div className="bg-card rounded-lg p-4 sm:p-6 border border-border shadow-sm hover:shadow-md transition-shadow flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground text-sm sm:text-base">Lahore, Punjab</p>
                                <p className="text-muted-foreground text-sm sm:text-base">Pakistan</p>
                            </div>
                        </div>
                    </div>
